...
void myproject_float(
    ...
    float layer13_out[N_FILT_13*N_OUTPUTS_13]
) {
    ...
    nnet::convert_data<result_t, float, N_FILT_13*N_OUTPUTS_13>(layer13_out_ap, layer13_out);
}

void myproject_double(
    double input_1[N_INPUT_1_1*N_INPUT_2_1],
    double layer13_out[N_FILT_13*N_OUTPUTS_13]
) {
    ...
    nnet::convert_data<result_t, double, N_FILT_13*N_OUTPUTS_13>(layer13_out_ap, layer13_out);
}
}
